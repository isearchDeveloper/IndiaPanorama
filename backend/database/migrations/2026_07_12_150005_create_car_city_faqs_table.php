...
/**
 * Backfills a migration for the pre-existing "car_city_faqs" table, which was
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('car_city_faqs')) {
            Schema::create('car_city_faqs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('car_city_faqs');
    }
};

...
/**
 * Backfills a migration for the pre-existing "car_routes_details" table, which was
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('car_routes_details')) {
            Schema::create('car_routes_details', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('car_routes_details');
    }
};

...
/**
 * Backfills a migration for the pre-existing "package_meta_data" table, which was
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('package_meta_data')) {
            Schema::create('package_meta_data', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('package_meta_data');
    }
};

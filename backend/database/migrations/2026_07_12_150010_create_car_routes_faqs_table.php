...
/**
 * Backfills a migration for the pre-existing "car_routes_faqs" table, which was
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('car_routes_faqs')) {
            Schema::create('car_routes_faqs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('car_routes_faqs');
    }
};

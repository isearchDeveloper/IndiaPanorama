...
/**
 * Backfills a migration for the pre-existing "car_city_details" table, which was
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('car_city_details')) {
            Schema::create('car_city_details', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('car_city_details');
    }
};

...
/**
 * Backfills a migration for the pre-existing "car_routes_meta_data" table, which was
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('car_routes_meta_data')) {
            Schema::create('car_routes_meta_data', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('car_routes_meta_data');
    }
};

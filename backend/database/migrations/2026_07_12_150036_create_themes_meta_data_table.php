...
/**
 * Backfills a migration for the pre-existing "themes_meta_data" table, which was
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('themes_meta_data')) {
            Schema::create('themes_meta_data', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('themes_meta_data');
    }
};

...
/**
 * Backfills a migration for the pre-existing "cms_page_meta_data" table, which was
...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('cms_page_meta_data')) {
            Schema::create('cms_page_meta_data', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cms_page_meta_data');
    }
};

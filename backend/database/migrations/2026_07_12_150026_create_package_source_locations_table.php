...
/**
 * Backfills a migration for the pre-existing "package_source_locations" table, which was
...
return new class extends Migration
{
    public function up(): void
    {
        if (!Schema::hasTable('package_source_locations')) {
            Schema::create('package_source_locations', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('package_source_locations');
    }
};

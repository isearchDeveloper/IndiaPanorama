...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h2">
                    <i class="fas fa-edit me-2"></i>Create News
                </h1>
    ...
    <div class="row">
        <div class="col-12">
            <form id="pageForm" method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <x-media-picker name="news_thumbnail" label="Banner Image" folder="news" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <input type="text" class="form-control @error('news_thumbnail_alt') is-invalid @enderror" id="news_thumbnail_alt" name="news_thumbnail_alt" placeholder="Banner Image Alt">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control no-char-limit tinymce @error('description') is-invalid @enderror" id="cms-page-description" name="description" rows="5">{{ old('description') }}
                                    </textarea>
                                    @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-12 text-right">
                                ...
                                <button type="submit" class="btn btn-success btn-lg" id="submit-btn">
                                    <i class="fas fa-save me-2"></i>Add News
                                </button>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function toggleNewsDate() {
        ...
        const wrapper = document.getElementById('news-date-wrapper');
        const dateInput = document.getElementById('news_date');

        if (type === 'newsletter') {
            // ✅ Newsletter → SHOW date
    ...
    $(document).on('submit', 'form', function(e) {
        ...
        if (hasError) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Invalid Image',
                text: 'Fix image size errors before submitting.',

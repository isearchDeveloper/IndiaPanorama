...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 mb-0 fw-bold"><i class="fas fa-user-edit me-2 text-success"></i>Edit Admin: {{ $adminUser->name }}</h2>
        </div>
    ...
    <form action="{{ route('admin.admin-management.update', $adminUser->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row g-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password_confirmation" autocomplete="new-password"
                                   class="form-control" minlength="8" placeholder="Repeat new password">
                        </div>
                    </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body" style="max-height:70vh; overflow-y:auto;">
                        ...
                        $groupIcons = [
                            ...
                            'Experiences'     => 'fas fa-compass text-info',
                                    ...
                                    @if($moduleKey)
                                        <div class="perm-module-row">
                                            ...
                                            <div class="perm-module-chips">
                                                ...
                                                @php
                                                    $checked = in_array($perm->name, old('permissions', $userPermissions));

...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h2">
                    <i class="fas fa-edit me-2"></i>Edit CMS Page
                </h1>
    ...
    <div class="row">
        <div class="col-12">
            <form id="pageForm" method="POST" action="{{ route('admin.cms-page.update',$page->id) }}" enctype="multipart/form-data">
                @csrf 
                @method('PUT')
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <!-- <input type="text" class="form-control @error('sub_title') is-invalid @enderror" id="sub_title" name="sub_title"  value="{{ old('sub_title',$page->sub_title) }}"> -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <x-media-picker name="banner_image" label="Banner Image" folder="cms_page" :value="$page->banner_image" />
                                        </div>
                                        <div class="mb-3">
                                            <input type="text"  class="form-control @error('banner_image_alt') is-invalid @enderror"  id="banner_image_alt" name="banner_image_alt"
                                        value="{{ old('banner_image_alt',$page->banner_image_alt) }}" placeholder="Banner Image Alt">
